...
namespace MY_DB_APP
{
    public partial class WorkersInfo : Form
    {
        public WorkersInfo()
        {
            InitializeComponent();
        ...
        private void WorkersInfo_Load(object sender, EventArgs e)
        {
            try
            {
                List<List<string>> list_list = PG.Select_all("Отчёт_о_зарплатах");
